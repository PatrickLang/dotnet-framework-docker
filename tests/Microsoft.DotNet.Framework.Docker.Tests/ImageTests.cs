...
namespace Microsoft.DotNet.Framework.Docker.Tests
{
    public class ImageTests
    {
        ...
        private const string WSC_1809 = "windowsservercore-1809";
        ...
        private static ImageDescriptor[] TestData = new ImageDescriptor[]
            {
                ...
                new ImageDescriptor { RuntimeVersion = "3.5", BuildVersion = "3.5", OsVariant = WSC_1809 },
                ...
                new ImageDescriptor { RuntimeVersion = "4.7.2", BuildVersion = "4.7.2", OsVariant = WSC_1809 },
            };
